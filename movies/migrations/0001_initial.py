    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('counry', models.CharField(max_length=30, verbose_name='Страна')),
                ('world_premiere', models.DateField(default=datetime.date.today, verbose_name='Премьера в мире')),
                ('budget', models.PositiveIntegerField(default=0, help_text='указать сумму в доллараж', verbose_name='Бюджет')),
                ('fees_in_usa', models.PositiveIntegerField(default=0, help_text='указать сумму в долларах', verbose_name='Сборы в США')),
                ('fess_in_word', models.PositiveIntegerField(default=0, help_text='указать сумму в долларах', verbose_name='Сборы в Мире')),
                ('url', models.SlugField(max_length=160, unique=True)),
                ...
                ('genres', models.ManyToManyField(to='movies.Ganre', verbose_name='Жанры')),
            ],
            options={
                'verbose_name': 'Фильм',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=100, verbose_name='Имя')),
                ('text', models.TextField(max_length=5000, verbose_name='Сщщобщение')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('movie', models.ForeignKey(on_delete=django.db.models.fields.CharField, to='movies.movie', verbose_name='фмльм')),
